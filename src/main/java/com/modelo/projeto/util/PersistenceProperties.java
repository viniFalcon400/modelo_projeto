...
public class PersistenceProperties {
	 ...
	 * procura é feita na pasta home do usuário, em variáveis de ambiente e
	 * em propriedades passadas na inicialização do processo Java.
	 *
	 ...
	 * usuário. Caso exista, ele irá ler as propriedades que estão dentro
	 * dele.
	 *
	...
	/**
	 * Verifica a existência de um parâmetro Java passado na inicialização
	 * da aplicação. Esse parâmetro deve se chamar "jdbc-file", portanto
	 * será passado dessa forma "-Djdbc-file=/caminho/jdbc.properites".
	 *
	 * A chave das propriedades desse arquivo devem ser iguais ao nome da
	 * propriedade do persistence.xml que se deseja sobreescrever.
	 *
